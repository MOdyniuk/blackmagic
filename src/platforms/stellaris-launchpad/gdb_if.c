...
static uint8_t uartRxRead;
static uint8_t uartRxWrite;
static uint8_t uartRxUsed;

#define UART_TX_BUF_SIZE 64
static uint8_t uartTxBuf[UART_TX_BUF_SIZE];
static uint8_t uartTxRead;
static uint8_t uartTxWrite;
static uint8_t uartTxUsed;
